...
public partial class TilesetResource : GameResource
{
	...
	public string SerializeString ()
	{
		var obj = new JsonObject()
		{
			...
			["InheritAutotileFrom"] = InheritAutotileFrom?.ResourcePath ?? "",
	...
	public void DeserializeString ( string json )
	{
		...
		InheritAutotileFrom = ResourceLibrary.GetAll<TilesetResource>().FirstOrDefault( x => x.ResourcePath == inheritId );
		InternalUpdateTiles();
	}
